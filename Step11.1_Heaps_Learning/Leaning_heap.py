...
Binary Heap: Heapify (Insert and delete) How heapify faster? start from last element like deletion
It takes O(n) times

Heap as priority Queue:
    Elements will have their priority, insertion and deletion happens as per elements priority
"""
